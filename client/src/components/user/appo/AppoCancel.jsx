...
const AppoCancel = () => {
  ...
  //model
  const [showAppoCancel, setShowAppoCancel] = useState(
    false
  );
  const handleAppoCancelShow = () =>
    setShowAppoCancel(true);
  const handleAppoCancelClose = () =>
    setShowAppoCancel(false);
  //form
