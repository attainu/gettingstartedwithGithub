...
const AppoCheck = () => {
  ...
  const handleAppoCheckClose = () =>
    setShowAppoCheck(false);
  //form
          ...
          <form onSubmit={formSubmitHandler}>
            ...
            <div className="form-group">
              ...
              <select
                className="form-control"
                onChange={(e) =>
                  setAppoTimeSloat(e.target.value)
                }>
                <option value="#">00:00 - 00:00</option>
                <option value="08:00am-08:30am">
                  08:00am - 08:30am
                </option>
                <option value="09:00am-09:30am">
                  09:00am - 09:30am
                </option>
                ...
                <option value="01:00pm-01:30pm">
                  01:00pm - 01:30pm
                </option>
                <option value="03:00pm-03:30pm">
                  03:00pm - 03:30pm
                </option>
                <option value="04:00pm-04:30pm">
                  04:00pm - 04:30pm
                </option>
                <option value="05:00pm-05:30pm">
                  05:00pm - 05:30pm
                </option>
              </select>
            </div>
