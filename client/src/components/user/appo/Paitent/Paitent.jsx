...
const PaitentDataBtn = () => {
  ...
  //model
  const [showPaitentData, setShowPaitentData] = useState(
    false
  );
  const handlePaitentDataShow = () =>
    setShowPaitentData(true);
  const handlePaitentDataClose = () =>
    setShowPaitentData(false);
  //form
  ...
  return (
    <>
      ...
      <Modal
        show={showPaitentData}
        onHide={handlePaitentDataShow}>
        <Modal.Header>
