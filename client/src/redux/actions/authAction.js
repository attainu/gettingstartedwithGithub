    ...
    return async (dispatch) => {
      try {
        const { data } = await axios({
          method: "Post",
          url:
            "https://vs-medcare.herokuapp.com/api/superadmin/superlogin",
    ...
    return async (dispatch) => {
      try {
        const { data } = await axios({
          method: "Post",
          url:
            "https://vs-medcare.herokuapp.com/api/admin/login",
          data: userLoginCredentials,
        });
    ...
    return async (dispatch) => {
      try {
        const { data } = await axios({
          method: "Post",
          url:
            "https://vs-medcare.herokuapp.com/api/user/login",
          data: userLoginCredentials,
        });
