  ...
  return async (dispatch) => {
    try {
      const { data } = await axios({
        method: "Post",
        url:
          "https://vs-medcare.herokuapp.com/api/superadmin/uploadDoc",
  ...
  return async (dispatch) => {
    try {
      const { data } = await axios({
        method: "Post",
        url:
          "https://vs-medcare.herokuapp.com/api/superadmin/deleteDoc",
  ...
  return async (dispatch) => {
    try {
      const { data } = await axios({
        method: "Post",
        url:
          "https://vs-medcare.herokuapp.com/api/superadmin/leaveDoc",
        data: addDocDataCredentials,
        headers: {
          "Content-Type": "application/json",
          Accept: "application/json",
      ...
      console.log(
        "Error in add doctor leave Action",
        err.message
      );
    }
  };
  ...
  return async (dispatch) => {
    try {
      const { data } = await axios({
        method: "Post",
        url:
          "https://vs-medcare.herokuapp.com/api/superadmin/leaveDocCancel",
      ...
      console.log(
        "Error in delete doctor leave Action",
        err.message
      );
    }
  };
...
export const viewDocData = () => {
  return async (dispatch) => {
    try {
      ...
      console.log(
        "Error in view doctor data Action",
        err.message
      );
    }
  };
