...
module.exports = {
  ...
  userHome: async (req, res, next) => {
    try {
      ...
      return res
        .status(400)
        .json({
          message: `Error in  user home data ${err.message}`,
        });
    }
  },
  ...
  adminHome: async (req, res, next) => {
    try {
      ...
      return res
        .status(400)
        .json({
          message: `Error in  admin home data ${err.message}`,
        });
    }
  },
  ...
  superAdminHome: async (req, res, next) => {
    try {
      ...
      console.log(
        "Error in super admin home data",
        err.message
      );
      return res
        .status(400)
        .json({
          message: `Error in  super admin home data ${err.message}`,
        });
    }
  },
};
