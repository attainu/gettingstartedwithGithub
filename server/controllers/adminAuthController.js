...
module.exports = {
  ...
  adminRegister: async (req, res, next) => {
    try {
      ...
      res.status(200).json({
        message:
          "Admin Data Added successfully, Admin have to click the link to activate their account",
      });
    } catch (err) {
  ...
  verifyResendToken: async (req, res, next) => {
    try {
      ...
      return res
        .status(400)
        .json({
          message: `Error in Token Resending ${err.message}`,
        });
    }
  },
  ...
  adminLogin: async (req, res, next) => {
    try {
      ...
      if (admin.isConfirmed != true) {
        return res
          .status(400)
          .json({ message: "Please verify you mail" });
      }
      ...
      return res
        .status(400)
        .json({
          message: `Error in userLogin ${err.message}`,
        });
    }
  },
  ...
  forgotPassword: async (req, res, next) => {
    try {
      ...
      return res
        .status(400)
        .json({
          message: `Error in generateOTP${err.message}`,
        });
    }
  },
  ...
  postOTP: async (req, res, next) => {
    try {
      ...
      return res
        .status(400)
        .json({
          message: `Error in postOTP${err.message}`,
        });
    }
  },
  ...
  updatePassword: async (req, res, next) => {
    try {
      ...
      return res
        .status(400)
        .json({
          message: `Error in updatePassword${err.message}`,
        });
    }
  },
  ...
  adminDelete: async (req, res, next) => {
    try {
      ...
      console.log(
        "Error in Deleting the Admin account",
        err.message
      );
